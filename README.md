...
Проект решил назвать просто и лаконично, А.П.О. </br>
***Автономный Помощник Оператора*** (станков с Программным Управлением то бишь ЧПУ) </br>
